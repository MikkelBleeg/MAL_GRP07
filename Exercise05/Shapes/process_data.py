...
data_paths = ['/ITMAL/MAL_GRP07/Project/shapes/triangle.MP4',
              '/ITMAL/MAL_GRP07/Project/shapes/square.MP4',
              '/ITMAL/MAL_GRP07/Project/shapes/circle.MP4',
              '/ITMAL/MAL_GRP07/Project/shapes/star.MP4']
#paths to folders where training data will be stored
folder_names = ['/ITMAL/MAL_GRP07/Project/shapes/triangle/0/',
                '/ITMAL/MAL_GRP07/Project/shapes/square/1/',
                '/ITMAL/MAL_GRP07/Project/shapes/circle/2/',
                '/ITMAL/MAL_GRP07/Project/shapes/star/3/']
